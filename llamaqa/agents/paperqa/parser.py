...
if __name__ == "__main__":
    text = """Thought: I need to use the gather_evidence tool to get information about the Enhanced IncomeShield plan before I can summarize it in point form with citations.
